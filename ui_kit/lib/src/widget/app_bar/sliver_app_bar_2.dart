...
/// app bar, see [SliverAppBar2], which embeds an [AppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
///  * [SliverAppBar2], which uses [AppBar] to provide a flexible app bar that
...
class AppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  ///
  /// Becomes the leading list_item of the [NavigationToolbar] built
  ...
  /// contents of the app.
  ///
  /// Becomes the middle list_item of the [NavigationToolbar] built by this widget.
  ...
  /// last action.
  ///
  /// The [actions] become the trailing list_item of the [NavigationToolbar] built
  ...
  /// changes the [AppBar]'s size. A [SliverAppBar2] in a [CustomScrollView]
  ...
  /// used by [SliverAppBar2] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  ...
  /// Defines the height of the toolbar list_item of an [AppBar].
  ///
...
class _AppBarState extends State<AppBar> {
  ...
  static const Color _defaultShadowColor = AppColorScheme.colorPrimaryBlack;
                ...
                ClipRect(
                  child: BackdropFilter(
                    filter: ImageFilter.blur(
                        sigmaX: 10.0 * widget.opacityNotifier.value, sigmaY: 10.0 * widget.opacityNotifier.value),
                    child: Container(
                      height: toolbarHeight,
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  bool shouldRebuild(covariant _SliverAppBarDelegate oldDelegate) {
    return leading != oldDelegate.leading ||
        ...
        opacityNotifier != oldDelegate.opacityNotifier ||
        leadingWidth != leadingWidth;
  }
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SliverAppBar2] into its
///    scrolling.
...
class SliverAppBar2 extends StatefulWidget {
  ...
  /// be the same as the app bar's overall height.
  ///
  /// When using [SliverAppBar2.flexibleSpace], the [SliverAppBar2.expandedHeight]
  /// must be large enough to accommodate the [SliverAppBar2.flexibleSpace] widget.
  ///
  /// Typically a [FlexibleSpaceBar]. See [FlexibleSpaceBar] for details.
  final Widget flexibleSpace;
  ...
  /// See also:
  ///
  ///  * [SliverAppBar2] for more animated examples of how this property changes the
...
class _SliverAppBar2State extends State<SliverAppBar2> with TickerProviderStateMixin {
